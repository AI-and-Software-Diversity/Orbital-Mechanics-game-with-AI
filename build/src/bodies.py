...
class Star2:
    ...
    used to create circles with hitboxes
    """
    def __init__(self, x, y, r, screen=None):
    ...
    def draw(self, screen=None):
        ...
        pygame.draw.circle(screen, (39, 176, 144), (self.x, self.y), self.r)
        # screen.blit(pygame.image.load("../assets/s10.png"), (self.x, self.y))
        # pygame.image.load("../assets/sun1.png")
        # screen.blit(screen, (self.x,self.y))
...
class Planet2:
    ...
    def draw(self, screen=None):
        ...
        pygame.draw.circle(screen, (self.rd, self.gn, self.bu), (self.x, self.y), self.r)
